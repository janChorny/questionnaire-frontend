                  ...
                  <div className="form__question">
                    ...
                    <div className="form__block">
                      ...
                      <div className="form__group">
                        ...
                        {errors.stomataEssentialBegin && <span className="form__error-span">Bitte, wählen Sie eine Antwortoption aus</span>}
                      </div>
                    </div>
                    ...
                    <div className="form__block">
                      ...
                      <div className="form__group">
                        ...
                        {errors.stomataEssentialQuantity && <span className="form__error-span">Bitte, wählen Sie eine Antwortoption aus</span>}
                      </div>
                    </div>
